...
urlpatterns = [
    ...
    path('admin-Add-Jewellerys', views.admin_Add_Jewellerys,
         name='admin-Add-Jewellerys'),
    ...
    path('return-refund-replacement', views.return_refund_replacement,
    ...
    path('Long-Necklace-Sets', views.Long_Necklace_Sets_fun,
         name='Long-Necklace-Sets'),
    ...
    path('Maang-Tikkas-And-Daminis', views.Maang_Tikkas_And_Daminis_fun,
         name='Maang-Tikkas-And-Daminis'),
    path('product/<title>', views.product),
    path('product/<int:id>/<category>/<title>', views.product),
